...
class Position(BaseModel):
    ...
    Position
    """ # noqa: E501
    accuracy: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Accuracy in meters")
    alt: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Altitude in meters")
    lat: Union[StrictFloat, StrictInt] = Field(description="Latitude")
    lon: Union[StrictFloat, StrictInt] = Field(description="Longitude")
    __properties: ClassVar[List[str]] = ["accuracy", "alt", "lat", "lon"]
